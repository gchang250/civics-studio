...
party: Liberal
riding: Beaches—East York, ON
keyPromises:
  - "Democratic reform including electoral reform and proportional representation"
  - "National pharmacare and dental care under a universal public framework"
  - "Bold climate action: net-zero 2035 for the electricity grid and a serious carbon price"
...
platformAlignment:
  - promise: "Housing supply through reform"
    voteSession: "45-1"
    voteNumber: 169
    rating: fulfilled
    explanation: "Erskine-Smith voted Yes at second reading of Bill C-26 (payments to improve housing supply), consistent with his housing platform."
  ...
  - promise: "National pharmacare and dental care"
    ...
    voteNumber: 173
    rating: fulfilled
    explanation: "Erskine-Smith voted Yes on the government's budget bill (C-30), supporting continued Liberal social investment. His personal platform calls for more ambition than the current government, but this vote reflects support for the direction."
  - promise: "Digital rights and data privacy"
    voteSession: "45-1"
    voteNumber: 170
