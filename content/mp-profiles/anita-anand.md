...
name: Anita Anand
party: Liberal
riding: Oakville East, ON
keyPromises:
  - "Campaigned on economic independence: 'Never again will we be 80 per cent dependent on one country for our stability, economically'"
...
platformAlignment:
  - promise: "Economic independence"
    ...
    voteNumber: 173
    rating: fulfilled
    explanation: "Anand voted Yes on final passage of the government's budget bill (C-30). As a cabinet minister bound by cabinet solidarity, this is expected, but it's also consistent with the broader economic-resilience platform she personally campaigned on."
  - promise: "Fight for the most vulnerable (housing affordability)"
    voteSession: "45-1"
    voteNumber: 169
    rating: fulfilled
